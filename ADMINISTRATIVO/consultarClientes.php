...
try {
    ...
    $queryClientes = "SELECT clienteId, clienteNome, clienteEmail FROM tabcliente";
    $stmtClientes = $conexao->query($queryClientes);
...
<body>
    ...
    <main>
        ...
        <div class="row">
            <h1 class="col s12 m12 l8 offset-l3">Clientes</h1>
        </div>

        <div class="row">

            <div class="col s12 m12 l8 offset-l3">
                <div style="border: solid 2px black; height: 400px; overflow-y: auto;">
                    ...
                    <table class="responsive-table">
                        ...
                        <tbody>
                            <?php
                            while ($rowcli = $stmtClientes->fetch(PDO::FETCH_ASSOC)) {
                                $clienteId = $rowcli['clienteId'];
                                $clienteNome = $rowcli['clienteNome'];
                                $clienteEmail = $rowcli['clienteEmail'];
                            ?>
                                <tr>
        ...
        <div class="row">
            <div class="col s12 m12 l5 offset-l3">
                <div style="border: solid 2px black; height: 400px;">
                </div>
            </div>
